...
pessoa = ["Iasmin","Ilana","Otavio","DESCONHECIDO"]
num_classes = (len(pessoa))
cap = cv2.VideoCapture(0) # pode colocar um video citando o nome entre aspas. extenssão

detector = MTCNN()
facenet = load_model("facenet_keras.h5")
model = load_model("faces_d.h5") #faces.h5
...
while True:
    cap = cv2.VideoCapture('http://192.168.0.7/cam-hi.jpg')  # pode colocar um video citando o nome entre aspas. extenssão
